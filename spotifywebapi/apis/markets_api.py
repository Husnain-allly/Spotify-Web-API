...
from spotifywebapi.models.markets import Markets
...
class MarketsApi(BaseApi):
    ...
    def __init__(self, config):
        super(MarketsApi, self).__init__(config)
    ...
    def get_available_markets(self):
        ...
        Returns:
            ApiResponse: An object with the response value as well as other
                useful information such as status codes and headers. A markets
                object with an array of country codes
