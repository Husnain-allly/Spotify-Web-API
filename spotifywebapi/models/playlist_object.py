...
class PlaylistObject(object):
    ...
    def __init__(self,
        ...
        """Constructor for the PlaylistObject class"""
    ...
    def from_dictionary(cls,
        ...
        tracks = PagingPlaylistTrackObject.from_dictionary(dictionary.get('tracks')) if 'tracks' in dictionary.keys() else APIHelper.SKIP
