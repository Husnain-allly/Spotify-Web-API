...
class CurrentlyPlayingObject(object):
    ...
    def from_dictionary(cls,
        ...
        item = APIHelper.deserialize_union_type(UnionTypeLookUp.get('CurrentlyPlayingObjectItem'), dictionary.get('item'), False) if dictionary.get('item') is not None else APIHelper.SKIP
