...
from spotifywebapi.models.play_history_object import PlayHistoryObject
...
class CursorPagingPlayHistoryObject(object):
    ...
    def __init__(self,
        ...
        """Constructor for the CursorPagingPlayHistoryObject class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('items') is not None:
            items = [PlayHistoryObject.from_dictionary(x) for x in dictionary.get('items')]
        else:
            items = APIHelper.SKIP
