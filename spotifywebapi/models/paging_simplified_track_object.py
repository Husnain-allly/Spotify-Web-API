...
from spotifywebapi.models.simplified_track_object import SimplifiedTrackObject
...
class PagingSimplifiedTrackObject(object):
    ...
    def __init__(self,
        ...
        """Constructor for the PagingSimplifiedTrackObject class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('items') is not None:
            items = [SimplifiedTrackObject.from_dictionary(x) for x in dictionary.get('items')]
