...
from spotifywebapi.models.artist_discography_album_object import ArtistDiscographyAlbumObject
...
class PagingArtistDiscographyAlbumObject(object):
    ...
    def __init__(self,
        ...
        """Constructor for the PagingArtistDiscographyAlbumObject class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('items') is not None:
            items = [ArtistDiscographyAlbumObject.from_dictionary(x) for x in dictionary.get('items')]
