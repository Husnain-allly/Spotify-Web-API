...
from spotifywebapi.models.saved_episode_object import SavedEpisodeObject


class PagingSavedEpisodeObject(object):

    """Implementation of the 'PagingSavedEpisodeObject' model.
    ...
    Attributes:
        ...
        items (List[SavedEpisodeObject]): The model property of type
            List[SavedEpisodeObject].
    ...
    def __init__(self,
        ...
        """Constructor for the PagingSavedEpisodeObject class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('items') is not None:
            items = [SavedEpisodeObject.from_dictionary(x) for x in dictionary.get('items')]
