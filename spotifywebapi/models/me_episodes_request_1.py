...
class MeEpisodesRequest1(object):
    ...
    Attributes:
        ids (List[str]): A JSON array of the [Spotify
            IDs](/documentation/web-api/concepts/spotify-uris-ids). <br/>A
            maximum of 50 items can be specified in one request. _**Note**: if
            the `ids` parameter is present in the query string, any IDs listed
    ...
    def __init__(self,
        ...
        """Constructor for the MeEpisodesRequest1 class"""
