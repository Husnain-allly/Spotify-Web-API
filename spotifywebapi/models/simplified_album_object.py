...
from spotifywebapi.models.album_restriction_object import AlbumRestrictionObject
from spotifywebapi.models.album_type import AlbumType
...
from spotifywebapi.models.release_date_precision import ReleaseDatePrecision
from spotifywebapi.models.simplified_artist_object import SimplifiedArtistObject
...
class SimplifiedAlbumObject(object):
    ...
    def __init__(self,
        ...
        """Constructor for the SimplifiedAlbumObject class"""
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.album_type,
                                           type_callable=lambda value: AlbumType.validate(value)) \
                and APIHelper.is_valid_type(value=dictionary.total_tracks,
                                            type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(value=dictionary.available_markets,
                ...
                and APIHelper.is_valid_type(value=dictionary.release_date_precision,
                                            type_callable=lambda value: ReleaseDatePrecision.validate(value)) \
                and APIHelper.is_valid_type(value=dictionary.mtype,
                                            type_callable=lambda value: isinstance(value, str)) \
                and APIHelper.is_valid_type(value=dictionary.uri,
                                            type_callable=lambda value: isinstance(value, str)) \
                and APIHelper.is_valid_type(value=dictionary.artists,
                                            type_callable=lambda value: SimplifiedArtistObject.validate(value),
                                            is_model_dict=True,
                                            is_inner_model_dict=True)
        ...
        return APIHelper.is_valid_type(value=dictionary.get('album_type'),
                                       type_callable=lambda value: AlbumType.validate(value)) \
            and APIHelper.is_valid_type(value=dictionary.get('total_tracks'),
                                        type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(value=dictionary.get('available_markets'),
                                        type_callable=lambda value: isinstance(value, str)) \
            ...
            and APIHelper.is_valid_type(value=dictionary.get('uri'),
                                        type_callable=lambda value: isinstance(value, str)) \
            and APIHelper.is_valid_type(value=dictionary.get('artists'),
                                        type_callable=lambda value: SimplifiedArtistObject.validate(value),
                                        is_model_dict=True,
                                        is_inner_model_dict=True)
