...
from spotifywebapi.models.saved_track_object import SavedTrackObject
...
class PagingSavedTrackObject(object):
    ...
    def __init__(self,
        ...
        """Constructor for the PagingSavedTrackObject class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('items') is not None:
            items = [SavedTrackObject.from_dictionary(x) for x in dictionary.get('items')]
