...
from spotifywebapi.models.chapter_base import ChapterBase
...
class PagingSimplifiedChapterObject(object):
    ...
    Attributes:
        ...
        items (List[ChapterBase]): The model property of type
            List[ChapterBase].
    ...
    def __init__(self,
        ...
        """Constructor for the PagingSimplifiedChapterObject class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('items') is not None:
            items = [ChapterBase.from_dictionary(x) for x in dictionary.get('items')]
