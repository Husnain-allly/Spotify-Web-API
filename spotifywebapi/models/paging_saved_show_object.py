...
from spotifywebapi.models.saved_show_object import SavedShowObject
...
class PagingSavedShowObject(object):
    ...
    def __init__(self,
        ...
        """Constructor for the PagingSavedShowObject class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('items') is not None:
            items = [SavedShowObject.from_dictionary(x) for x in dictionary.get('items')]
