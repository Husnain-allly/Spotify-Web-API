...
from spotifywebapi.models.simplified_playlist_object import SimplifiedPlaylistObject
...
class PagingPlaylistObject(object):
    ...
    def __init__(self,
        ...
        """Constructor for the PagingPlaylistObject class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('items') is not None:
            items = [SimplifiedPlaylistObject.from_dictionary(x) for x in dictionary.get('items')]
