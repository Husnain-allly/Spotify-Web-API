...
class PagingSimplifiedAudiobookObject(object):
    ...
    Attributes:
        ...
        items (List[AudiobookBase]): The model property of type
            List[AudiobookBase].
    ...
    def __init__(self,
        ...
        """Constructor for the PagingSimplifiedAudiobookObject class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('items') is not None:
            items = [AudiobookBase.from_dictionary(x) for x in dictionary.get('items')]
