...
from spotifywebapi.models.saved_audiobook_object import SavedAudiobookObject


class PagingSavedAudiobookObject(object):

    """Implementation of the 'PagingSavedAudiobookObject' model.
    ...
    Attributes:
        ...
        items (List[SavedAudiobookObject]): The model property of type
            List[SavedAudiobookObject].
    ...
    def __init__(self,
        ...
        """Constructor for the PagingSavedAudiobookObject class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('items') is not None:
            items = [SavedAudiobookObject.from_dictionary(x) for x in dictionary.get('items')]
