...
from spotifywebapi.models.playlist_track_object import PlaylistTrackObject


class PagingPlaylistTrackObject(object):

    """Implementation of the 'PagingPlaylistTrackObject' model.
    ...
    Attributes:
        ...
        items (List[PlaylistTrackObject]): The model property of type
    ...
    def __init__(self,
        ...
        """Constructor for the PagingPlaylistTrackObject class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('items') is not None:
            items = [PlaylistTrackObject.from_dictionary(x) for x in dictionary.get('items')]
