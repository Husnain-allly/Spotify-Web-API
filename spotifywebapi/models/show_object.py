...
class ShowObject(object):
    ...
    def __init__(self,
        ...
        """Constructor for the ShowObject class"""
    ...
    def from_dictionary(cls,
        ...
        episodes = PagingSimplifiedEpisodeObject.from_dictionary(dictionary.get('episodes')) if dictionary.get('episodes') else None
