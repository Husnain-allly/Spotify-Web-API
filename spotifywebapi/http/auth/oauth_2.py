...
from spotifywebapi.apis.oauth_authorization_api import\
    OauthAuthorizationApi
from spotifywebapi.exceptions.api_exception import ApiException
...
class Oauth2(HeaderAuth):
    ...
    def __init__(self, client_credentials_auth_credentials, config):
        ...
        self._oauth_clock_skew = client_credentials_auth_credentials.oauth_clock_skew \
            if client_credentials_auth_credentials is not None else None
        self._oauth_token_provider = client_credentials_auth_credentials.oauth_token_provider \
            if client_credentials_auth_credentials is not None else None
        self._oauth_on_token_update = client_credentials_auth_credentials.oauth_on_token_update \
            if client_credentials_auth_credentials is not None else None
