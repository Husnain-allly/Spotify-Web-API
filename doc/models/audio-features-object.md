...
| `analysis_url` | `str` | Optional | A URL to access the full audio analysis of this track. An access token is required to access this data. |
...
| `duration_ms` | `int` | Optional | The duration of the track in milliseconds. |
...
| `id` | `str` | Optional | The Spotify ID for the track. |
...
| `mtype` | [`Type5`](../../doc/models/type-5.md) | Optional | The object type. |
